...
<body class="govuk-template__body ">
    ...
    <div class="govuk-width-container ">
        <?php
        $app->crumb_string = "Home|/;Sections|/sections;Section " . $section->numeral . "|";
        require("../includes/crumb.php");
        ?>
        <main class="govuk-main-wrapper govuk-main-wrapper--auto-spacing" id="main-content" role="main">
            <div class="govuk-grid-row">
                <div class="govuk-grid-column-full">
                    <h1 class="govuk-heading-l">Section <?= $section->numeral ?> - <?= $section->title ?></h1>
                    <div class="govuk-tabs" data-module="govuk-tabs">
                        ...
                        <div class="govuk-tabs__panel" id="details">
                            <h2 class="govuk-heading-l">About this section</h2>
                        ...
                        <div class="govuk-tabs__panel" id="content">
                            ...
                            if (count($section->content) == 0) {
                                echo ("<p class='govuk-body'>There is no content attached to this section.");
                            } else {
                            ?>
                                <table class="govuk-table govuk-table--m">
                            ...
                            ?>
                            <p class="govuk-body"><a href="/content/add.html?link_type=section&sid=<?= $section->id ?>&id=<?= $section->numeral?>">Add content to section <?= $section->numeral ?></a></p>
                        </div>
                    </div>
                </div>
        </main>
